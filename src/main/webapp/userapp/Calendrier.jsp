...
<body>
    ...
    SimpleDateFormat sdfDayOfWeek = new SimpleDateFormat("EEEE"); // Day of the week (e.g., Monday)
    SimpleDateFormat sdfMonth = new SimpleDateFormat("MMMM"); // Month (e.g., January)
    SimpleDateFormat sdfDayOfMonth = new SimpleDateFormat("dd"); // Day of the month (e.g., 08th)

    String dayOfWeek = sdfDayOfWeek.format(currentDate);
    String month = sdfMonth.format(currentDate);
    String dayOfMonth = sdfDayOfMonth.format(currentDate);
%>

<h1 class="date"><%= dayOfWeek %><span><%= month %> <%= dayOfMonth %></span></h1>
					<div class="notes">
						<p>
			...
			<div class="col rightCol">
				<div class="content">
					...
					<ul class="weekday">
						<li><a href="#" title="Mon" data-value="1"class="selected">Mon</a></li>
					...
					<ul class="days">
						<script>
							for( var _i = 1; _i <= 31; _i += 1 ){
								var _addClass = '';
								if( _i === 08 ){ _addClass = ' class="selected"'; }
